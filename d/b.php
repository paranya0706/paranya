...
<body>
<h1>ฟอร์มรับข้อมูล - ปรัณญา ศรีบุญเพ็ง (หมวย)</h1>
...
<!--<button type="button" onDblClick="alert('อ่านทำไม');">Hello</button>-->
<button type="button"   onMouseOver="alert('อ่านทำไม');">Hello</button>
